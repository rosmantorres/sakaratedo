...
namespace ExcepcionesSKD.Modulo16
{
    ...
    public class ParseoFormatoInvalidoException : ExceptionSKD
    {
        ...
        /// </summary>
        public ParseoFormatoInvalidoException():base()
        {
        ...
        public ParseoFormatoInvalidoException(String mensaje):base(mensaje)
        {
        ...
        public ParseoFormatoInvalidoException(String mensaje, Exception excepcion):base(mensaje, excepcion)
        {
        ...
        /// <param name="mensaje"><El mensaje de error que se pasa al ocurrir la excepcion/param>
        /// <param name="excepcion">La excepcion como tal capturada</param>
        public ParseoFormatoInvalidoException(String codigo, String mensaje, Exception excepcion):base(codigo, mensaje, excepcion)
        {
