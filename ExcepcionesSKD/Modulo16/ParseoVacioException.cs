...
namespace ExcepcionesSKD.Modulo16
{
    ...
    public class ParseoVacioException : ExceptionSKD
    {
        ...
        /// </summary>
        public ParseoVacioException():base()
        {
        ...
        public ParseoVacioException(String mensaje):base(mensaje)
        {
        ...
        public ParseoVacioException(String mensaje, Exception excepcion):base(mensaje, excepcion)
        {
        ...
        /// <param name="mensaje"><El mensaje de error que se pasa al ocurrir la excepcion/param>
        /// <param name="excepcion">La excepcion como tal capturada</param>
        public ParseoVacioException(String codigo, String mensaje, Exception excepcion):base(codigo,mensaje,excepcion)
        {
