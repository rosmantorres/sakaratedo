...
namespace DatosSKD.Modulo4
{
    public class BDDojo
    {
        ...
        {
            BDConexion laConexion;
            List<Organizacion> laListaDeOrganizaciones = new List<Organizacion>();
            List<Parametro> parametros;
            ...
            try
            {
                ...
                DataTable dt = laConexion.EjecutarStoredProcedureTuplas(
                               RecursosBDModulo4.ConsultarOrganizaciones, parametros);
                foreach (DataRow row in dt.Rows)
                {

                    Organizacion laOrg = new Organizacion();

                    laOrg.Id_organizacion = int.Parse(row[RecursosBDModulo4.ParametroIdOrg].ToString());
                    laOrg.Nombre = row[RecursosBDModulo4.ParametroNombreOrg].ToString();

                    laListaDeOrganizaciones.Add(laOrg);
            ...
            return laListaDeOrganizaciones;
        }



        public static List<Dojo> ListarDojosXId(int idOrg)
        {
            BDConexion laConexion;
            List<Dojo> laListaDeDojos = new List<Dojo>();
            List<Parametro> parametros;
            ...
            try
            {
                ...
                Parametro elParametro = new Parametro(RecursosBDModulo4.ParametroIdOrg, SqlDbType.Int, idOrg.ToString(), false);
                parametros.Add(elParametro);
                ...
                foreach (DataRow row in dt.Rows)
                {
                    ...
                    elDojo.Id_dojo = int.Parse(row[RecursosBDModulo4.AliasIdDojo].ToString());
                    elDojo.Organizacion_dojo = int.Parse(row[RecursosBDModulo4.ParamIdOrganizacion].ToString());
        ...
        public static int ConsultarOrgPersona(int idPersona)
        {
            int retorno = 0;
            BDConexion laConexion;
            List<Parametro> parametros;
            ...
            try
            {
                ...
                elParametro = new Parametro(RecursosBDModulo4.ParametroOrgPersona, SqlDbType.Int, idPersona.ToString(), false);
                parametros.Add(elParametro);

                DataTable dt = laConexion.EjecutarStoredProcedureTuplas(RecursosBDModulo4.ConsultarOrgPersona, parametros);
        ...
        public static int ConsultarIdPersona (int idPersona)
        {
            int retorno = 0;
            BDConexion laConexion;
            List<Parametro> parametros;
            ...
            try
            {
                ...
                elParametro = new Parametro(RecursosBDModulo4.AliasIdPersona, SqlDbType.Int, idPersona.ToString(), false);
                parametros.Add(elParametro);

                DataTable dt = laConexion.EjecutarStoredProcedureTuplas(RecursosBDModulo4.ConsultarIdPersona, parametros);
