...
namespace PruebasUnitariasSKD.Modulo6
{
    ...
    class M6_PruebaDatosPersona
    {
        ...
        public void Prueba1GuardarNuevaPersona()
        {
            ...
            this._per.ContactoEmergencia = _perContacto;
            ...
            Assert.AreNotEqual(this._per.ContactoEmergencia.ID, -1);
            ...
            Assert.IsNotNull(this._per.ContactoEmergencia);
            Assert.AreEqual(this._per.ContactoEmergencia.ID, idContacto);
            
        }

        [Test]
        public void Prueba2GuardarNuevaPersonaRepresentante()
        {
            this._per.ContactoEmergencia = null;
        ...
        [Test]
        public void Prueba3GuardarPersona()
        {
            ...
            String nuevo_nombre = "Rómulo José";
            String nuevo_nombre_contacto = "Raiza Izabel";
            String nuevo_apellido = "Rodríguez Rojas";

            this._per.ContactoEmergencia.Nombre = nuevo_nombre_contacto;
            this._per.Nombre = nuevo_nombre;
            this._per.Apellido = nuevo_apellido;
            this._per.ContactoEmergencia = _perContacto;
            ...
            this._per = DatosSKD.Modulo6.BDUsuarios.GetInfoPersonaByID(id);
            DatosSKD.Modulo6.BDUsuarios.GetContacto(this._per);

            Assert.AreEqual(this._per.Nombre,nuevo_nombre);
            Assert.AreEqual(this._per.Apellido,nuevo_apellido);
            Assert.AreEqual(this._per.ContactoEmergencia.Nombre, nuevo_nombre_contacto);
        }
        ...
        public void Salir(){
            ...
            if (this._per.ID != -1)
            {
                if (this._tel1 != null)
                {
                    ...
                    if (this._per.ContactoEmergencia != null && this._per.ContactoEmergencia.Telefonos != null)
                    {
                        this.query("DELETE FROM dbo.TELEFONO WHERE PERSONA_per_id = " + this._per.ContactoEmergencia.ID.ToString());
                    }
                ...
                if (this._core != null)
                {
                    ...
                    if (this._per.ContactoEmergencia != null && this._per.ContactoEmergencia.Correos != null)
                    {
                        this.query("DELETE FROM dbo.EMAIL WHERE PERSONA_per_id = " + this._per.ContactoEmergencia.ID.ToString());
                    }
                }
                if (this._per.ContactoEmergencia != null)
                {
                    this.query("DELETE FROM dbo.RELACION WHERE PERSONA_per_id = " + this._per.ID.ToString());
                    this.query("DELETE FROM dbo.PERSONA WHERE per_id = " + this._per.ContactoEmergencia.ID.ToString());
                }
