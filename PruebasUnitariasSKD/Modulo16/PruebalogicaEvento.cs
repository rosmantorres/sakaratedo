...
namespace PruebasUnitariasSKD.Modulo16
{
    ...
    [TestFixture]
    public class PruebalogicaEvento
    {
        #region Atributos
        //Atributos con los que trabajara la clase

        private Logicaevento logeve;
        #endregion
        ...
        {
            /// Prueba unitaria que verifica que el objeto que instancia a logicaComra no es vacia
            Assert.IsNotNull(logeve.detalleEventoXId(1));
            ...
            Assert.AreEqual(logeve.detalleEventoXId(miEvento.Id_evento), logeve.detalleEventoXId(miEvento2.Id_evento));
