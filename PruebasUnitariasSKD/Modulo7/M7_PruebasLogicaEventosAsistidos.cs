...
namespace PruebasUnitariasSKD.Modulo7
{
    public class M7_PruebasLogicaEventosAsistidos
    {
        ...
        {
            List<Evento> listaCinta = logicaEventosAsistidos.obtenerListaDeEventos(idPersona);
        ...
        {
            List<Evento> listaCinta = logicaEventosAsistidos.obtenerListaDeEventos(-1);
        }
        ...
        {
            Evento listaCinta = logicaEventosAsistidos.detalleEventoID(-1);
        }
