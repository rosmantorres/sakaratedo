...
namespace PruebasUnitariasSKD.Modulo1
{
    ...
    class PruebasUnitariasDominio
    {
        ...
        public  void PruebaConstructorCuenta2()
        {
            ...
            Cuenta cuenta = new Cuenta(Int32.Parse(RecursosPU_Mod1.Id), RecursosPU_Mod1.usuario, RecursosPU_Mod1.PruebaErrorClave);
        ...
        public void PruebaConstructorCuenta3()
        {
            ...
            listaRol.Add(elRol);
            Cuenta cuenta = new Cuenta(RecursosPU_Mod1.usuario, RecursosPU_Mod1.PruebaErrorClave,listaRol);
