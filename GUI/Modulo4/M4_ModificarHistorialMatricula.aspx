<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Master/SKD.Master" AutoEventWireup="true" CodeBehind="M4_ModificarHistorialMatricula.aspx.cs" Inherits="templateApp.GUI.Modulo4.M4_ModificarHistorialMatricula" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="subtitulo" runat="server">Modificar Historial Matricula
</asp:Content>
            ...
            <%-- COMIENZO DEL FORMULARIO --%>
                <form role="form" name="agregar_historial_matricula" id="agregar_historial_matricula" method="post" runat="server">
                    ...
                    <div class="box-footer">
                        &nbsp;&nbsp;&nbsp;&nbsp
                        <asp:Button id="btn_modificarHistorialMatricula" class="btn btn-primary" type="submit" style="align-content:flex-end" runat="server" OnClick="Btn_ModificarHistorialM_Click" Text="Modificar"></asp:Button>
                        &nbsp;&nbsp
    ...
    <%-- FIN DEL FORMULARIO --%>
     ...
     <script type="text/javascript">
         ...
         $(document).ready(function () {
             ...
             $("#btn-modificarHistorialMatricula").click(function (evento) {
                 if ($("modalidadHM").val() == "") {
