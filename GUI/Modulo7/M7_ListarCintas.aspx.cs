            ...
            if (!IsPostBack)
            {
                try
                {
                    ...
                    foreach (Cinta cinta in laLista)
                    {
                        ...
                        this.laTabla.Text += M7_Recursos.AbrirTD + cinta.Id.ToString() + M7_Recursos.CerrarTD;
                        ...
                        this.laTabla.Text += M7_Recursos.BotonInfoAsistenciaAEventos + cinta.Id + M7_Recursos.BotonCerrar;
