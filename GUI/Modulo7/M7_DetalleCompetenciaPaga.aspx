<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Master/SKD.Master" AutoEventWireup="true" CodeBehind="M7_DetalleCompetenciaPaga.aspx.cs" Inherits="templateApp.GUI.Modulo7.M7_DetalleCompetenciaPaga" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="breads" runat="server">
    ...
    <div>
	    <ol class="breadcrumb" style="background-color:rgba(0,0,0,0);">
		    ...
		    <li>
			    <a href="M7_ListarPagosAEventos.aspx">Consultar Eventos Pagos</a> 
		    </li>
