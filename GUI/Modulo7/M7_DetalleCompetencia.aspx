<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Master/SKD.Master" AutoEventWireup="true" CodeBehind="M7_DetalleCompetencia.aspx.cs" Inherits="templateApp.GUI.Modulo7.M7_DetalleCompetencia" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="breads" runat="server">
    ...
    <div>
	    <ol class="breadcrumb" style="background-color:rgba(0,0,0,0);">
		    ...
		    <li>
			    <a href="M7_ListarAsistenciaAEventos.aspx">Consultar Eventos Asistidos</a> 
		    </li>
...
<asp:Content ID="Content4" ContentPlaceHolderID="subtitulo" runat="server">Detalle de Evento
</asp:Content>
<asp:Content ID="Content5" ContentPlaceHolderID="contenidoCentral" runat="server">
    <!-- general form elements -->
   <div class="box box-primary">
      <div class="box-header with-border">
         <h3 class="box-title">Detalle De Evento</h3>
      </div>
      <!-- /.box-header -->
      <!-- form start -->
      <form runat="server" role="form" name="detalle_evento" id="detalle_evento" method="post">
         <div class="box-body col-sm-12 col-md-12 col-lg-12 ">
                     ...
                     <div class="form-group col-sm-4 col-md-4 col-lg-4">
                      ...
                      <div class="form-group col-sm-4 col-md-4 col-lg-4">
                        <%--<asp:Label runat="server" name="tipo_evento" id="tipo_evento" Font-Size="Large"></asp:Label>--%>
                          <h4 id="tipo_evento1" runat="server" name="tipo_evento">&nbsp;Tipo: </h4>
                        <br />
                     </div>
                     <div class="form-group col-sm-4 col-md-4 col-lg-4">
                      ...
                      <div class="form-group col-sm-4 col-md-4 col-lg-4">
                        <%--<asp:Label runat="server" name="direccion_evento" id="direccion_evento" Font-Size="Large"></asp:Label>--%>
                          <h4 id="direccion_evento1" runat="server" name="direccion_evento">&nbsp;Dirección: </h4>
                        <br />
                     </div>
            ...
            <a class="btn btn-default" href="M7_ListarAsistenciaAEventos.aspx">Volver</a>
            </div>
                  </div>
               </div>
            </div>
