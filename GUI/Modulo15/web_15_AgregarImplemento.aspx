<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Master/SKD.Master" AutoEventWireup="true" CodeBehind="web_15_AgregarImplemento.aspx.cs" Inherits="templateApp.GUI.Modulo15.web_15_AgregarImplemento" %>
    ...
    <!-- Elementos generales del formulario -->
              <div class="box box-primary">
               ...
               <!-- Comienzo del formulario -->
                <form role="form" id="agregar_implemento"  runat="server">
