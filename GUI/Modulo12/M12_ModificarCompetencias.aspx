...
<!-- /.box-header -->
<!-- form start -->
<form role="form" name="agregar_competencia" id="agregar_competencia" method="post" action="M12_ListarCompetencias.aspx?success=3">
    ...
    <br />
     ...
     <br />
      ...
      <div class="box-footer">
         &nbsp;&nbsp;&nbsp;&nbsp
         <a id="btn-agregarComp" class="btn btn-primary" type="submit" href="M12_ListarCompetencias.aspx?eliminacionSuccess=3" onclick="return checkform();">Modificar</a>
         &nbsp;&nbsp
