...
<!-- /.box-header -->
<!-- form start -->
<form runat="server" role="form" name="modificar_competencia" id="modificar_competencia" method="post" action="M12_ListarCompetencias.aspx?success=3">
    ...
    <br />
     ...
     <br />
      ...
      <div class="box-footer">
         &nbsp;&nbsp;&nbsp;&nbsp
         <asp:Button id="btn_modificarComp" class="btn btn-primary" type="submit" runat="server" OnClick="btn_modificarComp_Click" Text="Modificar"></asp:Button>
         &nbsp;&nbsp
