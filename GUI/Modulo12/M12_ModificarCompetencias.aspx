...
<asp:Content ID="Content4" ContentPlaceHolderID="contenidoCentral" runat="server">
   ...
   <div class="box box-primary">
      <div class="box-header with-border">
         <h3 class="box-title">Modificar Competencia</h3>
      </div>
      <!-- /.box-header -->
      <!-- form start -->
                  ...
                  <div class="panel-body">
                     ...
                     <div class="col-sm-4 col-md-4 col-lg-4">
                        ...
                        <label class="radio-inline">
                           <asp:RadioButton runat="server" type="radio" Text="Kata" name="radioTipo" id="input_tipo_kata" GroupName="tipoComp" />
                        </label>
                        <label class="radio-inline">
                           ...
                           <div class="panel-body">
                              ...
                              <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                 ...
                                 <div class="col-sm-4 col-md-4 col-lg-4" >
                                    <div class="dropdown" runat="server" id="divComboCintaDesde">
                                       <asp:DropDownList ID="comboCintaDesde" BackColor="White"  class="btn btn-default dropdown-toggle" runat="server" OnSelectedIndexChanged="comboCintaDesde_SelectedIndexChanged" ClientIDMode="Static">
                                       </asp:DropDownList>
                                    </div>
                                 </div>
                                 <div class="col-sm-4 col-md-4 col-lg-4" >
                                    <div class="dropdown" runat="server" id="divComboCintaHasta">
                                       <asp:DropDownList ID="comboCintaHasta" BackColor="White"  class="btn btn-default dropdown-toggle" runat="server" OnSelectedIndexChanged="comboCintaHasta_SelectedIndexChanged" ClientIDMode="Static">
                                       </asp:DropDownList>
                                    </div>
                                 </div>
                              </div>
                              <div class="form-group col-sm-12 col-md-12 col-lg-12">
                                 ...
                                 <div class="col-sm-4 col-md-4 col-lg-4">
                                    ...
                                    <label class="radio-inline">
                                       <asp:RadioButton runat="server" type="radio" Text="M" name="radioSexoM" id="input_sexo_M" GroupName="sexoCategoria"/>
                                    </label>
                                    <label class="radio-inline">
                     ...
                     <div class="form-group col-sm-12 col-md-12 col-lg-12">
                        <div class="col-sm-5 col-md-5 col-lg-5">
                           <h3>Status:</h3>
                           <label class="radio-inline">
                              <asp:RadioButton runat="server" Text="Por Iniciar" type="radio" name="radioStatus" id="input_status_porIniciar" GroupName="statusComp"/>
                           </label>
                           <label class="radio-inline">
                              <asp:RadioButton runat="server" Text="En Curso" type="radio" name="radioStatus" id="input_status_enCurso" GroupName="statusComp"/>
                           </label>
                           <label class="radio-inline">
                           <asp:RadioButton runat="server" type="radio" name="radioStatus" id="input_status_Finalizado" Text="Finalizado" GroupName="statusComp"/></label>
                        </div>
                     ...
                     <div class="form-group col-sm-5 col-md-5 col-lg-5">
                        <br/>
                        &nbsp;&nbsp;&nbsp;
                        <asp:Button id="btn_modificarComp_Click" class="btn btn-primary" type="submit" runat="server" OnClick="btn_modificarComp_Click_Click" Text="Modificar"></asp:Button>
                        &nbsp;&nbsp;
