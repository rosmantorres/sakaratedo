		...
		<div class="col-md-3">
			<div id="id_otro" runat="server" class="form-group">
				<div class="icon-addon addon-lg">
					...
					<input style="margin-top:5%" runat="server" type="number" placeholder="Tiempo mínimo" class="form-control" id="tiempo_minimo" name ="tiempo_minimo" min="0" max="10">                    
					<input style="margin-top:5%" runat="server" type="number" placeholder="Tiempo maximo" class="form-control" id="tiempo_maximo" name ="tiempo_maximo" min="0" max="10">
                    <input style="margin-top:5%" runat="server" type="number" placeholder="Puntaje mínimo" class="form-control" id="puntaje_minimo" name="punto_minimo" min="0" max="10">
                    <input style="margin-top:5%" runat="server" type="number" placeholder="Horas docentes mínimas" class="form-control" id="horas_docentes" name="hora_docente" min="0" max="10">
