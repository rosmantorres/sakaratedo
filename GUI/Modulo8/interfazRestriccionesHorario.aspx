...
<asp:Content ID="Content4" ContentPlaceHolderID="contenidoCentral" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-sm-1"></div>
        <div class="col-sm-1"></div>
        <div class="col-sm-1"><span class="pull-left"><a class="btn btn-default glyphicon glyphicon-plus-sign" data-toggle="modal" data-target="#modal-update" href="../Master/Inicio.aspx"></a></span></div>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-footer">  
                <a id="btn-eliminar" type="button" class="btn btn-primary" href="interfazRestriccionesHorario.aspx?eliminacionSuccess=1">Eliminar</a>
