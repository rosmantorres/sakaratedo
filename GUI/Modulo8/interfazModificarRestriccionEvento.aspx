...
<%--    <asp:ScriptManager runat="server"></asp:ScriptManager>--%>
	...
	<ol class="breadcrumb" style="background-color:rgba(0,0,0,0);">
		...
		<li>
			<a href="../Modulo8/interfazRestriccionesEventos.aspx">Gestión Restricciones de Competencias</a>
		</li>
		
		<li class="active">
			Modificar Restriccion de Competencias
		</li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="titulo" runat="server">
    ...
    Gestión de Restricciones de Competencias
...
<%--                    </ContentTemplate>
                   ...
                   <a id="btn-cancelar" type="submit" style="margin-top:5%; margin-right:5%; height:35px" class="btn btn-default pull-right" href="interfazRestriccionesCompetencia.aspx">Cancelar</a>
				    ...
				    <asp:Button id="bAgregar" style="margin-top:5%" class="btn btn-primary" OnClick="btnaceptar_Click" type="submit" runat="server" Text = "Modificar"   ></asp:Button>
