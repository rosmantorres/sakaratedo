<%@ Page Title="" Language="C#" MasterPageFile="~/GUI/Master/SKD.Master" AutoEventWireup="true" CodeBehind="M13_KyuPrograma.aspx.cs" Inherits="templateApp.GUI.Modulo13.M13_Kyu_atletas" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="titulo" runat="server">Programa T&eacutecnico por Kyu</asp:Content>
<asp:Content ID="Content3" ContentPlaceHolderID="subtitulo" runat="server">Lista de Kyu</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="contenidoCentral" runat="server">
    ...
    <div align="center">
      <table class="table-hover table-bordered table-condensed">
        <tr>
          <td><a href="M13_ProgramaKyu.aspx"><img src="Kyu-imagenes/blanca-azul.jpg" width="92" height="72" class="img-responsive" /></a></td>
