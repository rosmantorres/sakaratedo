...
namespace DominioSKD.Entidades.Modulo4
{
    ...
    public class DojoM4 : Entidad
    {
        ...
        public DojoM4(int Id, string Rif, string Nombre, int Telefono, string Email, string Logo, bool Status, Organizacion organizacion, Ubicacion ubicacion)
        {
            this.id_dojo = Id;
            this.rif_dojo = Rif;
        ...
        //constructor sin id 
        public DojoM4(string Rif, string Nombre, int Telefono, string Email, string Logo, bool Status, Organizacion organizacion, Ubicacion ubicacion)
        {
            this.rif_dojo = Rif;
            this.nombre_dojo = Nombre;
            this.telefono_dojo = Telefono;
